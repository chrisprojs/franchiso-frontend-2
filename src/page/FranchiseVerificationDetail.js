    ...
    <div className="franchise-detail-page">
      ...
      <div className="detail-content">
        ...
        <div className="franchise-info-section">
          ...
          {/* Key Metrics (same as public detail) */}
...
export default FranchiseVerificationDetail
